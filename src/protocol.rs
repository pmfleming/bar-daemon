    ...
    json!({
        ...
        "snapshot": {
            "activity": {
                ...
                "weather": {
                    "available": true, "location": "Leiden", "timezone": "Europe/Amsterdam",
                    ...
                    "hourly": [{ "time_unix_ms": 1766448000000_i64, "temperature_c": 17.0, "precipitation_probability": 5, "condition": "Clear" }],
